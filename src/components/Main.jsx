...
const Main = () => {
    ...
    // select a random movie from array of movies
...
<p className='w-full md:max-w-[70%] lg:max-w-[50%] xl:max-w-[35%] text-gray-700'>
    Overview:  {reducestring(movie?.overview, 150)}   
   </p>
